...
const Shop = () => {
  ...
  // Initialize avatarItems based on the unlocked state in localStorage
  // const avatarItems = initialAvatarItems.map((item) => {
  ...
  return (
    <div className="p-6 w-full">
      <div className="w-full">
        <h1 className="text-4xl font-bold text-purple-800 mb-6">Game Shop</h1>
